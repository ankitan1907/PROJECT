...
import { ChevronRight, ChevronLeft, MessageCircleMore, LogOut, Settings, Users } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    ...
    >
      <motion.button
        className="absolute -right-3 top-16 bg-gray-800 rounded-full p-1 border border-gray-700 text-gray-400 z-10"
              ...
              return (
                ...
                >
                  <div className={`flex items-center justify-center ${
                    currentRoom.id === room.id ? 'text-blue-300' : 'text-gray-400'
                  }`}>
                      ...
                      >
                        <div className="flex justify-between items-center">
                          ...
                          <Badge 
                            ...
                            color={currentRoom.id === room.id ? 'blue' : 'purple'} 
                          />
                        </div>
                      </motion.div>
                    )}
                  ...
                  {!isCollapsed && (
                    ...
                    >
                      <div className="flex flex-col">
                        ...
                        <span className="text-gray-400 text-xs">{LANGUAGES.find(l => l.code === user.language)?.name}</span>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>

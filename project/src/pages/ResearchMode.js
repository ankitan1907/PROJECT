                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="file" className="block text-sm font-medium text-gray-700">
                      Dataset File (CSV, Excel, JSON, GeoJSON, NetCDF) <span className="text-red-500">*</span>
                    </label>
                    ...
                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                      <div className="space-y-1 text-center">
                        ...
                        <div className="flex text-sm text-gray-600">
                          ...
                          >
                            ...
                            <input
                              ...
                              type="file" 
                              className="sr-only"
                              accept=".json,.geojson,.csv,.xlsx,.xls,.nc"
                        ...
                        <p className="text-xs text-gray-500">Supported formats: .csv, .xlsx, .xls, .json, .geojson, .nc (max 10MB)</p>

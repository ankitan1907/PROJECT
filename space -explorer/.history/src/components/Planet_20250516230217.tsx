        ...
        {name.toLowerCase() === 'saturn' && ringGeometry && ringTexture && (
          ...
          >
            ...
            <meshStandardMaterial
              ...
              opacity={0.9}
              depthWrite={false}
              color={new THREE.Color(0xffffff)} // Make sure color is pure white (can tweak to slight yellow if wanted)
  emissive={new THREE.Color(0x222222)} // Slight subtle glow for brightness

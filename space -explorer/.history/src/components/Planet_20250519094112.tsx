...
const Planet: React.FC<PlanetProps> = ({
  ...
  // Visually enhance the eccentricity for better effect (not to scale)
  const exaggeratedEccentricity = Math.min((eccentricity ?? 0) * 5, 0.6);

  // Elliptical orbit parameters
  const a = distance ?? 10;
  const e = exaggeratedEccentricity;

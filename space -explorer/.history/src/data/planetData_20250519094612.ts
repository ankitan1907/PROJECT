...
export const planetData: PlanetData[] = [
  {
    ...
    initialAngle: 0,
    eccentricity: 0.206,
    inclination: 7,  // Mercury's orbit inclination ~7 degrees
    facts: {
  ...
  },
  {
    ...
    initialAngle: 1.5,
    eccentricity: 0.007,
    inclination: 3.4,  // Venus's orbit inclination ~3.4 degrees
    facts: {
  ...
  },
  {
    ...
    initialAngle: 3,
    eccentricity: 0.017,
    inclination: 0, // Earth's orbit is the reference plane, so 0 degrees
    facts: {
  ...
  },
  {
    ...
    initialAngle: 4.5,
    eccentricity: 0.093,
    inclination: 1.85, // Mars inclination ~1.85 degrees
    facts: {
  ...
  },
  {
    ...
    initialAngle: 6,
    eccentricity: 0.049,
    inclination: 1.3, // Jupiter inclination ~1.3 degrees
    facts: {
  ...
  },
  {
    ...
    initialAngle: 7.5,
    eccentricity: 0.056,
    inclination: 2.5, // Saturn inclination ~2.5 degrees
    facts: {
  ...
  },
  {
    ...
    initialAngle: 9,
    eccentricity: 0.046,
    inclination: 0.77, // Uranus inclination ~0.77 degrees
    facts: {
  ...
  },
  {
    ...
    initialAngle: 10.5,
    eccentricity: 0.010,
    inclination: 1.77, // Neptune inclination ~1.77 degrees
    facts: {

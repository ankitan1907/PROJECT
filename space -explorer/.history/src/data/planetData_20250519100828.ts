...
export const planetData: PlanetData[] = [
  {
    ...
    initialAngle: 0,
    eccentricity: 0.205, // realistic Mercury eccentricity
    facts: {
  ...
  },
  {
    ...
    initialAngle: 4.5,
    eccentricity: 0.093,  // Mars eccentricity
    facts: {
  ...
  },
  {
    ...
    initialAngle: 6,
    eccentricity: 0.048,  // Jupiter eccentricity
    facts: {
  ...
  },
  {
    ...
    initialAngle: 7.5,
    eccentricity: 0.056,  // Saturn eccentricity
    facts: {
  ...
  },
  {
    ...
    initialAngle: 9,
    eccentricity: 0.047,  // Uranus eccentricity
    facts: {
  ...
  },
  {
    ...
    initialAngle: 10.5,
    eccentricity: 0.009,  // Neptune eccentricity
    facts: {

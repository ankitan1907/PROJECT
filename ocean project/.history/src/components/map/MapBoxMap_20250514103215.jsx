    ...
    >
      ...
      {features.map((feature, idx) => (
        <Marker
          ...
          anchor="bottom"
        >
          <div className={`w-3 h-3 rounded-full ${feature.feature_type === 'tectonic_plate' ? 'bg-coral' : ''}`} title={feature.name}></div>
        </Marker>
      ))}
    </Map>
  );
...
export default MapBoxMap; // Make sure the component is exported

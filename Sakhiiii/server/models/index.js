...
export const connectDB = async () => {
  try {
    ...
    if (!mongoUri) {
      ...
      const localUri = 'mongodb://localhost:27017/sakhi-dev';
    ...
    console.log('📝 Note: Make sure MongoDB is running or MONGODB_URI is correct');
    
    // Continue running without database for frontend-only mode
...
const seedDemoData = async () => {
  try {
    ...
    if (safeZoneCount === 0) {
      console.log('🌱 Seeding Safe Zones and Risk Zones...');
